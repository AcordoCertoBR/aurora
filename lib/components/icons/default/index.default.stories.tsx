...
export const ArrowDownCircle: Story = {
  render: (args) => {
    return <IconArrowDownCircle {...args} />
  },
...
export const ArrowRightCircle: Story = {
  render: (args) => {
    return <IconArrowRightCircle {...args} />
  },
...
export const Check: Story = {
  render: (args) => {
    return <IconCheck {...args} />
  },
  name: 'Check',
}

export const ChevronsDown: Story = {
  render: (args) => {
    return <IconChevronsDown {...args} />
  },
  name: 'ChevronsDown',
}
...
export const CloudRain: Story = {
  render: (args) => {
    return <IconCloudRain {...args} />
  },
  name: 'CloudRain',
}

export const CloudSnow: Story = {
  render: (args) => {
    return <IconCloudSnow {...args} />
  },
  name: 'CloudSnow',
}
...
export const CornerLeftDown: Story = {
  render: (args) => {
    return <IconCornerLeftDown {...args} />
  },
  name: 'CornerLeftDown',
}
...
export const MoreHorizontal: Story = {
  render: (args) => {
    return <IconMoreHorizontal {...args} />
  },
  name: 'MoreHorizontal',
}
